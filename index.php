...
.feature-list li i {
    ...
    border-radius: 8px;
    background: rgba(244,130,31,0.25);
    display: flex; align-items: center; justify-content: center;
...
.btn-login {
    background: linear-gradient(135deg, #008161, #00a67c);
    ...
    box-shadow: 0 4px 14px rgba(0,129,97,0.3);
}
.btn-login:hover {
    background: linear-gradient(135deg, #006e54, #008161);
    color: #fff;
    transform: translateY(-1px);
    box-shadow: 0 6px 18px rgba(0,129,97,0.38);
}
...
<div class="login-right">
    <div class="login-form-wrap">
        ...
        <div style="background:#f0faf7;border-radius:10px;padding:12px 16px;border:1px solid #b3ddd2;">
